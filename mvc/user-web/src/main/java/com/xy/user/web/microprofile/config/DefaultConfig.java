...
import com.xy.user.web.microprofile.config.source.ConfigSources;
import com.xy.user.web.microprofile.config.converter.Converters;
...
public class DefaultConfig implements Config {
    ...
    public DefaultConfig(ConfigSources configSource, Converters converters) {
        this.configSources = configSource;
