...
public class Recv2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        channel.queueBind(MqUtil.PUB_SUB_QUEUE_MAIL, MqUtil.EXCHANGE_FANOUT_NAME, MqUtil.ROUTING_KEY_INFO);
        channel.queueBind(MqUtil.PUB_SUB_QUEUE_MAIL, MqUtil.EXCHANGE_FANOUT_NAME, MqUtil.ROUTING_KEY_WARNING);
        //保证一次只分发一个
        channel.basicQos(1);
